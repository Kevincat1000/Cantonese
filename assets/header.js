(function () {
  ...
  const SITE_DOMAIN = "cantoneseinamericas.com"; // 你的域名
  ...
  function insertHeaderStyles() {
    ...
    const css = `
      ...
      header[data-site-header="1"] .header-search form { display: flex; align-items: center; gap: .5rem; margin: 0; }
      ...
      header[data-site-header="1"] .header-search button{ height:32px; width:32px; border-radius:6px; border:1px solid #E5DBCA; background:#F5F0E5; cursor:pointer; display:inline-flex; align-items:center; justify-content:center; color:#333; padding: 0; }
      ...
      header[data-site-header="1"] .mobile-nav-link:hover, header[data-site-header="1"] .mobile-nav-link:active{ background-color:#EAE4D5; color:#8B2332; }
            ...
            <nav class="nav-menu" aria-label="Primary">
              ...
              <div class="header-search">
                <form id="googleSearchForm">
                    <input id="googleSearchInput" type="search" placeholder="Search" autocomplete="off" aria-label="Search site" />
  ...
  function initSiteSearch() {
    ...
    form.addEventListener("submit", (e) => {
      ...
      // 构造 Google 搜索链接
      const googleUrl = `https://www.google.com/search?q=site:${SITE_DOMAIN}+${encodeURIComponent(query)}`;
