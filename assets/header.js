...
<style id="header-styles">
  ...
  /* ✅ default: leave room for fixed header */
  body { padding-top: var(--header-h); }

  /* ✅ when header is hidden, remove that space (fixes the beige bar) */
  body.header-hidden-pad { padding-top: 0; }

  header .header-container { max-width: 1280px; margin: 0 auto; padding: 0 1rem; }
  header .header-content { display: flex; align-items: center; justify-content: space-between; padding: 0.75rem 1rem; }

  header .logo { text-align: center; padding: 0 0.5rem; text-decoration: none; transition: opacity 0.3s; }
  header .logo:hover { opacity: 0.9; }

  header .logo-main {
    font-family: 'Lato', -apple-system, BlinkMacSystemFont, sans-serif;
    font-size: 24px; font-weight: bold;
    color: #8B2332; letter-spacing: 0.5px; line-height: 1.2;
  }
  header .logo-sub {
    font-family: 'Lato', -apple-system, BlinkMacSystemFont, sans-serif;
    font-size: 16px; font-weight: bold;
    color: #8B2332; letter-spacing: 2px; line-height: 1.2;
  }

  header .nav-menu { display: none; align-items: center; gap: 1.5rem; position: relative; }
  @media (min-width: 768px) { header .nav-menu { display: flex; } }
  ...
  header .mobile-menu-btn { display: block; background: none; border: none; cursor: pointer; padding: 0.5rem; color: #333; }
  @media (min-width: 768px) { header .mobile-menu-btn { display: none; } }
